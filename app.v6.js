// app.js v6 — Never cancel TTS on page navigation (next/prev). Keeps speaking in all modes.
(function(){
  'use strict';
  ...
  let currentCategory = Object.keys(WORDS)[0] || '동물';
  if(!WORDS[currentCategory]) WORDS[currentCategory] = [["cat","고양이"],["dog","개"]];
  ...
  function showTTSBroken(){ ttsBroken = true; const el=$('ttsBroken'); if(el) el.style.display='block'; }
